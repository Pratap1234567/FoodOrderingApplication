...
public class CustomerContoller {
	...
	@PostMapping(value = "addingtoWishList/{uid}/{pid}")
	public Customer addingtoWishlist(@PathVariable ("uid") int uid,@PathVariable("pid")  int pid) throws Exception {
		System.out.println();
		System.out.println();
		System.out.println();
		System.out.println();
		System.out.println("adding to wishList called");
	...
	public void deletecartitem(@PathVariable("id") int id) {
		System.out.println("deletecart called");
...
//	Adding Address
	...
	@PostMapping(value="saveAddress/{uid}")
	public void addAddress(@PathVariable("uid") int uid ,@RequestBody Address add ) {
		customerService.saveDeliveryAddress(uid,add);
	}
